use crate::riot_api::clients::{
    ...
    asset_models::{Agent, PlayerCard, RiotVersion},
};
...
#[tauri::command]
pub async fn get_agent_by_id(id: String) -> Result<Agent, String> {
    AssetClient::get_agent_by_id(id.as_str()).await.map_err(|e| e.to_string())
}
