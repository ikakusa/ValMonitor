...
pub struct PrivatePresence {
    pub is_idle: bool,
    pub is_valid: bool,
    pub match_presence_data: Option<MatchPresenceData>,
    pub max_party_size: i32,
    pub party_id: Option<String>,
    pub party_owner_match_score_ally_team: i32,
    pub party_owner_match_score_enemy_team: i32,
    pub party_presence_data: Option<PartyPresenceData>,
    pub party_size: i32,
    pub player_presence_data: Option<PlayerPresenceData>,
    pub premier_presence_data: Option<PremierPresenceData>,
